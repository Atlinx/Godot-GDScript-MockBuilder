...
signal _called_test_sub_class_func()
var _return_test_sub_class_func
func test_sub_class_func():
	emit_signal("_called_test_sub_class_func")
	return _return_test_sub_class_func


signal _called__private_sub_class_func()
var _return__private_sub_class_func
func _private_sub_class_func():
	emit_signal("_called__private_sub_class_func")
	return _return__private_sub_class_func
